        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-10 leading-relaxed">
              Add text, images, shapes, links, notes, and more. Reorder, rotate, and delete pages. Professional PDF editing in your browser. No signup required.
            </p>

            {/* CTA Button */}
            <button
              onClick={onFileSelect}
              className="inline-flex items-center justify-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all text-lg mb-6 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            >
              Choose PDF file
            </button>
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 shadow-lg border border-gray-200">
                ...
                <div className="absolute -bottom-3 -right-3 bg-gray-900 text-white px-4 py-2 rounded-lg shadow-md text-sm font-semibold">
                  Edit Pages
                </div>
              </div>
            </div>
