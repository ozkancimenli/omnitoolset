          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              onClick={() => {
                ...
                if (typeof window !== 'undefined' && (window as any).setShowSocialShare) {
                  (window as any).setShowSocialShare(true);
                }
              }}
            ...
            <button
              onClick={() => {
                if (typeof window !== 'undefined' && (window as any).setShowPdfComparison) {
                  (window as any).setShowPdfComparison(true);
                }
              }}
