...
export default function JpgPngConvert() {
  ...
  return (
    <ToolBase
      ...
      icon="🖼️"
      helpText="Convert images between JPG and PNG formats. Adjustable quality for JPG output. Preserves image dimensions."
      tips={[
      ...
      <div className="space-y-4">
        {!isProcessing && (
          <FileUploadArea
            ...
            icon="🖼️"
            text="Drag and drop your JPG or PNG file here or click to select"
          />
        )}
