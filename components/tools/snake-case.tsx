...
export default function SnakeCase() {
  ...
  return (
    <ToolBase
      ...
      icon="🐍"
      helpText="Convert any text to snake_case format. All lowercase with underscores between words. Perfect for Python variable names and database columns."
      tips={[
        'All lowercase letters',
        'Words separated by underscores',
        'Removes special characters',
        'Commonly used in Python and databases',
