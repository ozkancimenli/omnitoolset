...
function getBusinessContext(business) {
  return {
    ...
    type: business.business_type || business.businessType || env.defaultBusiness.businessType,
    services: business.services_summary || business.servicesSummary || env.defaultBusiness.servicesSummary,
    hours: business.hours_summary || business.hoursSummary || env.defaultBusiness.hoursSummary,
    pricing:
      business.price_summary || business.priceSummary || env.defaultBusiness.priceSummary
  };
}
