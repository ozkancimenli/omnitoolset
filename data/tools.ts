...
export const tools: Tool[] = [
  ...
  // Video Converter Tools
  {
    ...
    description: 'Convert video files between different formats (MP4, AVI, MOV, MKV, etc.)',
    icon: '🎬',
    category: 'Media',
    slug: 'video-converter',
    keywords: 'video converter, convert video, video format converter, mp4 converter, avi converter, mov converter, mkv converter, video converter online, video converter free, convert video online, best video converter, free video converter, online video converter, video format converter online',
  },
  {
    id: 'mp4-converter',
    title: 'MP4 Converter',
    ...
    category: 'Media',
    slug: 'mp4-converter',
    keywords: 'mp4 converter, convert to mp4, video to mp4, mp4 converter online, mp4 converter free, convert video to mp4, best mp4 converter, free mp4 converter, online mp4 converter, mp4 converter tool',
  },
  {
    id: 'video-to-gif',
    title: 'Video to GIF',
    ...
    category: 'Media',
    slug: 'video-to-gif',
    keywords: 'video to gif, convert video to gif, video gif converter, video to gif online, video to gif free, mp4 to gif, video gif maker, best video to gif converter, free video to gif, online video to gif',
  },
  {
    id: 'mov-to-mp4',
    title: 'MOV to MP4',
    ...
    category: 'Media',
    slug: 'mov-to-mp4',
    keywords: 'mov to mp4, convert mov to mp4, mov mp4 converter, mov to mp4 online, mov to mp4 free, convert mov file, mov converter, best mov to mp4 converter, free mov to mp4, online mov to mp4',
  },
  {
    id: 'video-to-mp3',
    title: 'Video to MP3',
    description: 'Extract audio from video files and convert to MP3',
    icon: '🎵',
    category: 'Media',
    slug: 'video-to-mp3',
    keywords: 'video to mp3, extract audio from video, video to audio converter, video to mp3 online, video to mp3 free, convert video to mp3, extract audio, video audio extractor, best video to mp3 converter, free video to mp3',
  },
  ...
  // Audio Converter Tools
  {
    ...
    description: 'Convert audio files between different formats (MP3, WAV, AAC, OGG, etc.)',
    icon: '🎵',
    category: 'Media',
    slug: 'audio-converter',
    keywords: 'audio converter, convert audio, audio format converter, mp3 converter, wav converter, aac converter, audio converter online, audio converter free, convert audio online, best audio converter, free audio converter, online audio converter, audio format converter online',
  },
  {
    id: 'mp3-converter',
    title: 'MP3 Converter',
    ...
    category: 'Media',
    slug: 'mp3-converter',
    keywords: 'mp3 converter, convert to mp3, audio to mp3, mp3 converter online, mp3 converter free, convert audio to mp3, best mp3 converter, free mp3 converter, online mp3 converter, mp3 converter tool',
  },
  {
    id: 'mp4-to-mp3',
    title: 'MP4 to MP3',
    description: 'Extract audio from MP4 video files and convert to MP3',
    icon: '🎵',
    category: 'Media',
    slug: 'mp4-to-mp3',
    keywords: 'mp4 to mp3, extract audio from mp4, mp4 to mp3 converter, mp4 to mp3 online, mp4 to mp3 free, convert mp4 to mp3, extract audio mp4, mp4 audio extractor, best mp4 to mp3 converter, free mp4 to mp3',
  },
  
  // Image Converter Tools (Additional)
  {
    id: 'heic-to-jpg',
    title: 'HEIC to JPG',
    ...
    category: 'Image',
    slug: 'heic-to-jpg',
    keywords: 'heic to jpg, convert heic to jpg, heic jpg converter, heic to jpg online, heic to jpg free, convert heic file, heic converter, best heic to jpg converter, free heic to jpg, online heic to jpg, heic to jpeg',
  },
  {
    id: 'image-to-pdf',
    title: 'Image to PDF',
    ...
    category: 'Image',
    slug: 'image-to-pdf',
    keywords: 'image to pdf, convert image to pdf, image pdf converter, image to pdf online, image to pdf free, convert images to pdf, picture to pdf, best image to pdf converter, free image to pdf, online image to pdf',
  },
  ...
  // Document & Ebook Converters
  {
    id: 'pdf-to-word',
    title: 'PDF to WORD',
    description: 'Convert PDF files to Microsoft Word format',
    icon: '📝',
    category: 'PDF',
    slug: 'pdf-to-word',
    keywords: 'pdf to word, pdf to docx, convert pdf to word, pdf to word converter, pdf to word online, pdf to word free, convert pdf word, pdf word converter, pdf to docx converter, how to convert pdf to word, best pdf to word converter, pdf to word tool, free pdf to word, online pdf to word, pdf to word no registration, convert pdf to docx online, pdf to word editor',
  },
  {
    ...
    category: 'PDF',
    slug: 'epub-to-pdf',
    keywords: 'epub to pdf, convert epub to pdf, epub pdf converter, epub to pdf online, epub to pdf free, convert epub file, epub converter, best epub to pdf converter, free epub to pdf, online epub to pdf, ebook to pdf',
  },
  {
    id: 'epub-to-mobi',
    title: 'EPUB to MOBI',
    ...
    category: 'Other',
    slug: 'epub-to-mobi',
    keywords: 'epub to mobi, convert epub to mobi, epub mobi converter, epub to mobi online, epub to mobi free, convert epub file, epub converter, best epub to mobi converter, free epub to mobi, online epub to mobi, ebook converter',
  },
  {
    id: 'document-converter',
    title: 'Document Converter',
    description: 'Convert between various document formats (PDF, Word, Excel, PowerPoint, etc.)',
    icon: '📄',
    category: 'PDF',
    slug: 'document-converter',
    keywords: 'document converter, convert documents, document format converter, pdf word excel converter, document converter online, document converter free, convert documents online, best document converter, free document converter, online document converter',
  },
  
  // Archive & Time Converters
  {
    id: 'rar-to-zip',
    title: 'RAR to ZIP',
    ...
    category: 'Other',
    slug: 'rar-to-zip',
    keywords: 'rar to zip, convert rar to zip, rar zip converter, rar to zip online, rar to zip free, convert rar file, rar converter, best rar to zip converter, free rar to zip, online rar to zip, archive converter',
  },
  {
    id: 'pst-to-est',
    title: 'PST to EST',
    ...
    category: 'Other',
    slug: 'pst-to-est',
    keywords: 'pst to est, pacific time to eastern time, timezone converter pst est, convert pst to est, pst est converter, time zone converter, pst to est online, pst to est free',
  },
  {
    id: 'cst-to-est',
    title: 'CST to EST',
    ...
    category: 'Other',
    slug: 'cst-to-est',
    keywords: 'cst to est, central time to eastern time, timezone converter cst est, convert cst to est, cst est converter, time zone converter, cst to est online, cst to est free',
  },
  {
    ...
    keywords: 'archive converter, convert archives, archive format converter, zip rar converter, archive converter online, archive converter free, convert archives online, best archive converter, free archive converter, online archive converter',
  },
  ...
  // Unit Converters
  {
    ...
    category: 'Other',
    slug: 'lbs-to-kg',
    keywords: 'lbs to kg, pounds to kilograms, convert lbs to kg, lbs kg converter, pounds kg converter, weight converter, lbs to kg online, lbs to kg free, convert pounds to kg',
  },
  {
    id: 'kg-to-lbs',
    title: 'Kg to Lbs',
    ...
    category: 'Other',
    slug: 'kg-to-lbs',
    keywords: 'kg to lbs, kilograms to pounds, convert kg to lbs, kg lbs converter, kilograms pounds converter, weight converter, kg to lbs online, kg to lbs free, convert kg to pounds',
  },
  {
    id: 'feet-to-meters',
    ...
    category: 'Other',
    slug: 'feet-to-meters',
    keywords: 'feet to meters, convert feet to meters, feet meters converter, ft to m converter, length converter, feet to meters online, feet to meters free, convert ft to m',
  },
  {
    id: 'unit-converter',
    title: 'Unit Converter',
    description: 'Convert between various units (length, weight, volume, temperature, etc.)',
    icon: '🔄',
    category: 'Other',
    slug: 'unit-converter',
    keywords: 'unit converter, convert units, measurement converter, length weight volume converter, unit converter online, unit converter free, convert units online, best unit converter, free unit converter, online unit converter, measurement converter online',
  },
  ...
  // Currency Converter
  {
    ...
    keywords: 'currency converter, convert currency, exchange rate converter, currency converter online, currency converter free, convert currencies, exchange rate calculator, best currency converter, free currency converter, online currency converter, real-time currency converter, usd eur gbp converter',
  },
  
  // GIS/CAD Converter (Simplified)
  {
    id: 'gis-converter',
    title: 'GIS/CAD Converter',
    description: 'Convert GIS and CAD formats (KML, KMZ, GeoJSON, DXF, DWG, Shapefile, etc.)',
    icon: '🗺️',
    category: 'Other',
    slug: 'gis-converter',
    keywords: 'gis converter, cad converter, kml converter, geojson converter, dxf converter, dwg converter, shapefile converter, gis format converter, cad format converter, gis converter online, gis converter free, convert gis formats, convert cad formats, kml to geojson, geojson to kml, dxf to dwg, shapefile converter online',
  },
];
